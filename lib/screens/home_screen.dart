...
import '../models/pokemon_color.dart';
import '../models/pokemon_types_model.dart';
import '../models/pokemons_models.dart';
...
class HomeScreen extends StatelessWidget {
                ...
                if (snapshot.hasError) {
                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    return _pokemonColor(
                        snapshot.data, pokemons, index + 1, context);
                  } else {
                    return const CircularProgressIndicator();
                  }
                }
  ...
  Widget _pokemonTypes(List<PokemonTypesModel>? data, PokemonColorModel? color,
      PokemonsModel? pokemon, int id, BuildContext context) {
  ...
  Widget _pokemonColor(PokemonColorModel? color, PokemonsModel? pokemon, int id,
